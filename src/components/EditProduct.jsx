...
const EditProduct = () => {
  ...
  const updateProducts = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://eduwork-backendmongo.herokuapp.com//api/v4/product/${id}`, {
        name,
        price,
        stock,
        status,
  ...
  return (
    <div>
      <h1 className="font-bold text-blue-600 mt-5 ml-20 text-2xl ">Form Edit Products</h1>

      <form onSubmit={updateProducts} className="w-full bg-blue-600 border border-blue-900 rounded-2xl mt-2 ml-20 p-4 max-w-sm  ">
